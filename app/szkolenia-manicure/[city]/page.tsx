        ...
        <div className="container">
          <div className="mb-12">
            <h2 className="text-4xl lg:text-5xl font-baloo font-bold text-black mb-4">
              Szkolenia z Manicure {city.name}
            </h2>
            <p className="text-gray-500 max-w-2xl font-poppins font-normal">
              Profesjonalne szkolenia i kursy z manicure w {city.name}. Rozwijaj swoje umiejętności pod okiem doświadczonych instruktorów.
            </p>
            <div className="mt-6">
...
export async function generateMetadata({
  ...
  return {
    title: `Szkolenia z Manicure ${cityData.name} - Profesjonalne Kursy`,
    description: `Znajdź najlepsze szkolenia z manicure w ${cityData.name}. Profesjonalne kursy, certyfikaty i rozwój umiejętności.`,
    openGraph: {
      type: "website",
      title: `Szkolenia z Manicure ${cityData.name} - Profesjonalne Kursy`,
      description: `Znajdź najlepsze szkolenia z manicure w ${cityData.name}. Profesjonalne kursy, certyfikaty i rozwój umiejętności.`,
