        ...
        <div className="container">
          <div className="mb-12">
            <h1 className="text-4xl lg:text-5xl font-baloo font-bold text-black mb-4">
              Kurs manicure {city.name} 2026 - Szkolenie hybryda {city.name}
            </h1>
            <p className="text-gray-500 max-w-2xl font-poppins font-normal text-base sm:text-lg">
              Profesjonalne szkolenia i kursy z manicure w {city.name}. Ile kosztuje kurs stylizacji paznokci? Sprawdź cennik szkoleń hybrydowych i opinie absolwentek kursów. Rozwijaj swoje umiejętności pod okiem doświadczonych instruktorów.
            </p>
...
export async function generateMetadata({
  ...
  return {
    title: `Kurs manicure ${cityData.name} 2026 - Szkolenie hybryda ${cityData.name} | Ile kosztuje kurs stylizacji paznokci`,
    description: `Kurs manicure ${cityData.name} - sprawdź ile kosztuje kurs stylizacji paznokci w 2026. Szkolenie hybryda ${cityData.name}, opinie absolwentek kursów, ile zarobisz po kursie manicure. Profesjonalne kursy z certyfikatami.`,
