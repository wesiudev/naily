...
// Util for minimal, readable HTML <p> wrappers
const p = (parts: string[]) =>
  parts.map((t) => `<p>${t}</p>`).join("\n");

const now = new Date();

type BlogPostInput = Omit<BlogPost, "createdAt" | "updatedAt" | "author" | "published" | "updatedAt"> & {
  createdAtOffsetDays: number;
  statistics: BlogPost["statistics"];
  author?: BlogAuthor; // allows override, fallback to defaultAuthor
  updatedAt?: Date; // for specific cases
  published?: boolean;
};

const postsData: BlogPostInput[] = [
  {
    id: "podstawy-manicure-baza-ementora",
    slug: "podstawy-manicure-baza-ementora",
    title: "Podstawy manicure: baza e‑mentora",
    excerpt: "Kluczowe filary profesjonalnego manicure – narzędzia, przygotowanie płytki i bezpieczeństwo.",
    tags: ["manicure", "porady", "podstawy"],
    createdAtOffsetDays: 10,
    published: true,
    coverImageUrl: "https://images.unsplash.com/photo-1519012811492-5e3ca4fcc22b?q=80&w=1200&auto=format&fit=crop",
  ...
  },
  {
    ...
    excerpt: "Prosty przewodnik dla początkujących – od matowienia do perfekcyjnego topu.",
    tags: ["hybryda", "techniki"],
    createdAtOffsetDays: 9,
    published: true,
    coverImageUrl: "https://images.unsplash.com/photo-1522336572468-8d6a820b0b38?q=80&w=1200&auto=format&fit=crop",
  ...
  },
  {
    ...
    excerpt: "Bezpieczne metody usuwania stylizacji – pilnik, frezarka i wrapy z acetonem.",
  ...
  },
  {
    ...
    excerpt: "Architektura paznokcia, apex i prawidłowe budowanie – wprowadzenie dla startu.",
    tags: ["zel", "techniki", "architektura"],
    createdAtOffsetDays: 7,
    published: true,
    coverImageUrl: "https://images.unsplash.com/photo-1519414442781-87dc1b5de2bc?q=80&w=1200&auto=format&fit=crop",
  ...
  },
  {
    ...
    excerpt: "Kropki, cienkie linie i pastelowe akcenty – szybkie zdobienia dla każdego.",
    tags: ["nail-art", "trendy"],
    createdAtOffsetDays: 6,
    published: true,
    coverImageUrl: "https://images.unsplash.com/photo-1518987048-4f322d0d4a39?q=80&w=1200&auto=format&fit=crop",
  ...
  },
  {
    ...
    excerpt: "Dezynfekcja, sterylizacja i praca ze skórkami – standardy, których warto się trzymać.",
    tags: ["higiena", "porady"],
    createdAtOffsetDays: 5,
    published: true,
    coverImageUrl: "https://images.unsplash.com/photo-1542718618-52b6e34ddac1?q=80&w=1200&auto=format&fit=crop",
  ...
  },
  {
    ...
    excerpt: "Jak wzmocnić zniszczone paznokcie po stylizacji? Skuteczne protokoły e‑mentora.",
    tags: ["zdrowie", "regeneracja"],
    createdAtOffsetDays: 4,
    published: true,
    coverImageUrl: "https://images.unsplash.com/photo-1543363136-7c99da9d13f4?q=80&w=1200&auto=format&fit=crop",
  ...
  },
  {
    ...
    excerpt: "Migdał, owal, kwadrat, ballerina – jak dobrać kształt do dłoni i stylu życia.",
    tags: ["ksztalty", "stylizacja"],
    createdAtOffsetDays: 3,
    published: true,
    coverImageUrl: "https://images.unsplash.com/photo-1519681393784-d120267933ba?q=80&w=1200&auto=format&fit=crop",
  ...
  },
  {
    ...
    excerpt: "Co kupić na start? Przegląd parametrów, bezpieczeństwo pracy i polecane akcesoria.",
    tags: ["sprzet", "porady"],
    createdAtOffsetDays: 2,
    published: true,
    coverImageUrl: "https://images.unsplash.com/photo-1514986888952-8cd320577b68?q=80&w=1200&auto=format&fit=crop",
  ...
  },
  {
    ...
    excerpt: "Od pasteli po głęboki burgund – paleta, która zdominuje najbliższe miesiące.",
    tags: ["trendy", "kolory"],
    createdAtOffsetDays: 1,
    published: true,
    coverImageUrl: "https://images.unsplash.com/photo-1545235617-9465d2a55698?q=80&w=1200&auto=format&fit=crop",
...
// post factory with automatic dates and author
function buildPost(data: BlogPostInput): BlogPost {
  return {
    ...data,
    author: data.author ?? defaultAuthor,
    createdAt: new Date(now.getTime() - data.createdAtOffsetDays * 24 * 60 * 60 * 1000),
    updatedAt: data.updatedAt ?? now,
    published: data.published ?? true,
  };
}

export const staticBlogPosts: BlogPost[] = postsData.map(buildPost);
